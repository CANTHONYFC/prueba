		...
		$.ajax({
			...
			success: function (data) {
																												...
																												<div class="card type--profile m-10">
																													<header class="card-heading card-blue">
																														...
																														<div class="card-body">
																															...
																															<button type="button" class="btn btn-blue btn-round btn-sm btn-identificado" data-indice="${data.data[i][1]}">REALIZAR RESERVA</button>
																														</div>
				...
				$('.btn-identificado').click((e) => {
					mostrarBootbox($(e.currentTarget).data('indice'))
...
function mostrarBootbox (codigocuarto){
	codigo=codigocuarto
					...
					<div class="col-xs-6">
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control datepicker" id="start_date" placeholder="Fecha de inicio" aria-label="Use the arrow keys to pick a date">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                            <input type="text" class="form-control datepicker" id="end_date" placeholder="Fecha fin" aria-label="Use the arrow keys to pick a date">
                          </div>
                        </div>
                      </div>
												...
												<div class="form-group label-floating is-empty">
														...
														<input min="1" pattern="^[0-9]+"  max="20" id="cantidad" type="number" class="form-control">
													</div>
